...
def assignRandomStats(agent, inventory=None, utility=None, wealth=None):
    ...
    logging.debug("Assigned agent " + str(agent.id) + " random stats with a wealth of " + str(agent.getWealth()))

""" generateRandomSet generates a set of random goods in random quantitiesa """
